...
export default function Form() {
  ...
  return (
    <form onSubmit={handleform} className="sm:flex sm:justify-center sm:flex-col flex justify-center sm:py-4 px-10 flex-col xl:py-16 ">
        <fieldset className="flex justify-between border-2 rounded-lg h-14">
            ...
            <div className=" flex justify-center flex-col items-center text-center py-2">
                <label htmlFor="" className="flex items-center">
                    <input  required className="sm:w-5 sm:h-5" type="checkbox"/>Send notification to my email                        
                </label>
