...
export default function Home() {
  return (
    <section className='flex flex-col m-20 sm:m-8 sm:items-center md:items-center lg: text-white py-52 xl:px-20 xl:py-36 2xl:pl-28'>
      <h1 className='sm:text-5xl md:text-4xl lg:text-4xl 2xl:text-6xl sm:text-center md:text-center font-bold'>For the love of manga</h1>
