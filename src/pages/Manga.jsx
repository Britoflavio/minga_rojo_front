import ok from '/src/imagenes/ok.png'
import bad from '/src/imagenes/bad.png'
import like from '/src/imagenes/like.png'
import sorprise from '/src/imagenes/sorprise.png'
     ...
     <div>
      ...
      {show ? (
        <div className="min-h-screen pt-20 flex flex-col items-center">
          ...
          <img className="sm:w-72 sm:h-80 " src={mangas.cover_photo} alt="" />

          <h2 className="text-5xl m-5">{mangas.title}</h2>
        ...
        <div className="min-h-screen pt-20 flex flex-col items-center">
          ...
          <div className="flex flex-col mt-12 sm:w-[95%] 
          md:flex md:flex-col md:mt-12 md:w-[78%] md:p-8 focus:underline-offset-8">
          ...
          {count > 5 && <div className="w-3/5 mt-4 mb-6 flex justify-center gap-8">
            {page != 1 && (<input className={`font-bold w-20 h-8 bg-slate-600 rounded-full`} type="button" value='<<' onClick={prev}></input>)}
            {page != cantPages1 && (<input className={`font-bold w-20 h-8 bg-orange-600 rounded-full`} type="button" value='>>' onClick={next}></input>)}
