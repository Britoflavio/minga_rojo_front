    ...
    <>
      ...
      <div className='flex flex-col justify-center items-center h-screen w-full bg-slate-200'>
        ...
        <form onSubmit={handlerForm} className='w-2/5 h-2/4 flex flex-col justify-around items-center'>
          ...
          <div>
            <select className='w-96 sm:w-56 border-b-2 bg-slate-200 border-black px-4 py-2 rounder' ref={categoryId}>
              <option>Insert Category</option>
              {categoryIds()}
            </select>
          </div>
          <div>
            <textarea className='w-96 sm:w-56 border-b-2 bg-slate-200 border-black  px-4 py-2 rounder' type='text' placeholder='Insert description' ref={description} />
          </div>
          <button type='submit'>
