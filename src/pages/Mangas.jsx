                  ...
                  <div key={manga._id} className="bg-white drop-shadow-xl mt-4 rounded-2xl ml-4 mr-4">
                    <div className="flex h-48 lg:h-56 xl:h-48 2xl:h-56">
                      ...
                      <div className="flex w-3/5 flex-col justify-center">
                        ...
                        <p className='ml-4 font-semibold text-base' style={{ color: manga.category_id.color }}>{manga.category_id.name.charAt(0).toUpperCase() + manga.category_id.name.slice(1)}</p>
                        <Anchor className="flex justify-center" to={`/manga/${manga._id}`}><button className="bg-[#D1FBF0] text-[#00BA88] rounded-xl m-4 w-1/2">Read</button></Anchor>
                      </div>
